            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[800px] text-center">
                <h1 className="mb-5 text-3xl leading-tight font-bold text-black sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight dark:text-white">
                  MentorQuest: Plataforma de Mentoria Profissional Integrada ao
                  LinkedIn
                </h1>
                <p className="text-body-color dark:text-body-color-dark mb-12 text-base leading-relaxed! sm:text-lg md:text-xl">
                  Conecte-se com mentores e mentorados, crie atividades
                  personalizadas, receba avaliações detalhadas e conquiste
                  certificados de aptidão validados. Amplie sua rede e
                  visibilidade no LinkedIn, compartilhe conquistas e participe
                  de uma comunidade focada em desenvolvimento profissional.
                  MentorQuest une crescimento, networking e credibilidade em um
                  só lugar.
                </p>
